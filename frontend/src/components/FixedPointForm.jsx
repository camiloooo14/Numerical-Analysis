    ...
    <div className="frf-container">
      <div className="frf-card">
        ...
        <form onSubmit={handleSubmit} className="frf-form">
          <label>
            Función f(x)
            <input type="text" name="f_expr" placeholder="x^3 + x - 1" value={form.f_expr} onChange={handleChange} required />
          </label>
          <label>
            Función g(x)
            <input type="text" name="g_expr" placeholder="1 - x^3" value={form.g_expr} onChange={handleChange} required />
          </label>
          <label>
            Valor inicial (x₀)
